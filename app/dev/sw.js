const CACHE = 'lumo-console-v7';
const ASSETS = ['./','./index.html','./manifest.json','./assets/dev.css?v=7','./assets/console.css?v=7','./assets/dev.js?v=7','./assets/developer.svg','./assets/developer.png'];
